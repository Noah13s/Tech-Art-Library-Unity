...
//     version 1.8.1
//     from Packages/com.n04h.techartlibrary/Base/Players/FPS/FPS_Controls.inputactions
//
...
public partial class @FPS_Controls: IInputActionCollection2, IDisposable
{
    ...
    ~@FPS_Controls()
    {
        Debug.Assert(!m_FPS_Action_Map.enabled, "This will cause a leak and performance issues, FPS_Controls.FPS_Action_Map.Disable() has not been called.");
    }
