...
float _Seed;
float _CloudFrameIndex;
half _NumPrimarySteps;
half _NumLightSteps;
half _BaseStepSize;
half _AdaptiveStepSizeFactor;
half _MaxStepSize;
...
half _MacroShapeScale;
half _CumulusScale;
half _CumulusStrength;
half _VerticalDevelopment;
